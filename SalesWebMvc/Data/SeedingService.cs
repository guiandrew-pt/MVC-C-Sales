...
namespace SalesWebMvc.Data
{
	public class SeedingService
	{
        ...
        public void Seed()
        {
            ...
            {
                return; // DB has been seeded; (Already have data)
            }
            ...
            Seller seller1 = new Seller(1, "Bruce Kim", "bruce@gmail.com", new DateTime(1998, 4, 21), 1000.0, department1);
            Seller seller2 = new Seller(2, "Albert Lee", "albert@gmail.com", new DateTime(1979, 12, 31), 3500.0, department2);
            ...
            Seller seller5 = new Seller(5, "Donald Duck", "donald@gmail.com", new DateTime(1993, 1, 9), 4000.0, department3);
            Seller seller6 = new Seller(6, "Captain America", "captain@gmail.com", new DateTime(1997, 3, 4), 3000.0, department2);
